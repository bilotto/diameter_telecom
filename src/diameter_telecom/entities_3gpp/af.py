...
class AF():
    ...
    def setup_app(self, app_id: int, max_threads: int = 1, request_handler: Callable = handle_request_rx):
    ...
    def setup_rx_app(self, max_threads: int = 1, request_handler: Callable = handle_request_rx):
